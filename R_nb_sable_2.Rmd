...
#the spGLM attempt
m.jitter <- spGLM(data~Sable_geo_df_binary.LONGITUDE + Sable_geo_df_binary.LATITUDE, family="binomial", coords=Sable_geo_binary$coords, data=Sable_coord_binary_jitter_gdf, n.samples = 100, cov.model="exponential",
...
Crap. Cholessky failed again in spGLM
--> maybe let's delete the overlap instead of jittering the overlap!
...
my_variog_sable_jitter<- variog(Sable_geo_distinct_altered, trend="1st") 
#my_variog_sable_2<- variog(Sable_geo_binary, trend="2nd") 
