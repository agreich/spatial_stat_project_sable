...
m.4 <- spGLM(data~LONGITUDE + LATITUDE, family="binomial", coords=Sable_geo_binary$coords, data=Sable_geo_df_binary, n.samples = 100, cov.model="exponential",
             starting=list("phi"=sable_WLS_phi,"sigma.sq"=sable_WLS_sigsq, "beta"=beta.starting, "w"= sable_WLS_w), priors=list("phi.Unif"=c(1, 2), "sigma.sq.IG"=c(2,1), "w"=c(0.5, 2)), tuning=list("phi"=0.5, "sigma.sq"=0.5, "beta"= beta.tuning, "w" = 0.5),
